...
```bash
sudo -u minecraft bash -c 'cd /srv/minecraft && java -Xms6G -Xmx6G -jar fabric-server-mc.1.21.1-loader.0.18.0-launcher.1.1.0.jar nogui'
```
...
```bash
sudo -u minecraft bash -c 'cd /srv/minecraft && screen -S mc -dm bash -lc "java -Xms6G -Xmx6G -jar fabric-server-mc.1.21.1-loader.0.18.0-launcher.1.1.0.jar nogui"'
```
